...
export default function BileklikPage() {
  const allItems = useMemo(() => PRODUCTS.filter((p) => p.category === 'bileklik'), []);
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 text-stone-500 text-sm">
                ...
                <span>›</span>
                <span className="text-primary font-medium">Bileklik</span>
              </div>
              ...
              <p className="mt-2 text-stone-600 leading-relaxed">
                Şık ve tamamlayıcı dokunuşlar… Nazar Kuyumculuk’un seçili bilekliklerini burada
                inceleyebilirsiniz.
              </p>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-stone-200">
              <div>
                <div className="text-sm text-stone-500">Bileklik</div>
