...
export default function YuzukPage() {
  const allItems = useMemo(() => PRODUCTS.filter((p) => p.category === 'yuzuk'), []);
  ...
  // Modal açıkken: body scroll kilidi + ESC + ok tuşları
  useEffect(() => {
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 text-stone-500 text-sm">
                ...
                <span>›</span>
                <span className="text-primary font-medium">Yüzük</span>
              </div>
              ...
              <p className="mt-2 text-stone-600 leading-relaxed">
                Sade çizgilerden taşlı modellere… Nazar Kuyumculuk’un seçili yüzüklerini burada
                inceleyebilirsiniz.
              </p>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-stone-200">
              <div>
                <div className="text-sm text-stone-500">Yüzük</div>
